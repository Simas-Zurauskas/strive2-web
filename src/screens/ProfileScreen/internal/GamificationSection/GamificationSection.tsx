...
const BADGES = [
  ...
  { id: 'insight_first', name: 'First Recall', requirement: 'Rate your first insight' },
  { id: 'insight_mastered_first', name: 'Committed to Memory', requirement: 'Master your first insight' },
  { id: 'insight_cross_course_day', name: 'Interleaved Mind', requirement: 'Review insights from 3 courses in a day' },
