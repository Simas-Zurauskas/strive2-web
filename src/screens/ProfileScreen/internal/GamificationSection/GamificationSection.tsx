...
const BADGES = [
  ...
  { id: 'recall_first', name: 'First Recall', requirement: 'Rate your first recall card' },
  { id: 'recall_mastered_first', name: 'Committed to Memory', requirement: 'Master your first recall card' },
  { id: 'recall_cross_course_day', name: 'Interleaved Mind', requirement: 'Review recall cards from 3 courses in a day' },
